...
from MyOpinionsApp.models import User, Post, Quote, Comment
from MyOpinionsApp.forms import RegistrationForm, LoginForm, UpdateForm, PostForm, CommentForm
...
def create_comment(post_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('my_post',post_id=post.id))
...
def delete_comment(comment_id):
    ...
    return redirect(url_for('my_post', post_id=comment.post.id))